    ...
    <>
      ...
      <div className="container mx-auto mt-8 bg-white dark:bg-stone-950 pb-20	">
        <Banner
          ...
          description={
            "New on a journey of Shopify app development mastery. Our concise and practical guides to empowers you to create robust and scalable apps tailored to your business needs. "
          }
